...
[^2]: Sun-tzu(孫子, 손자) 정리라고도 한다. [관련 글](https://udaqueness.blog/2019/01/17/crt-%ec%9c%a0%ea%b0%90/).
...
$a\in I_1$, $1-a\in I_2$이므로, $1=a+(1-a)\in I_1+I_2$, $I_1$과 $I_2$는 서로소이다.

## 이 포스트에서는...

- **환에서의 중국인의 나머지 정리**를 증명했다.
