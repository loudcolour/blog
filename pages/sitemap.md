작성 예정이거나 이미 작성된 포스트의 목록을 (주관적인) 학습단계에 따라 정렬했습니다.

## Set Theory

- 사상, 단사, 전사, 전단사
- [Bernstein 정리: 양방향의 단사 사상에 의한 전단사 사상의 존재](/2021/02/bernstein/)
- Cantor 대각선논법
- 동치관계, 동치류
- 순서관계
    - 정렬순서
    - 순서수
- 선택공리
    - Zorn 보조정리, Tukey 보조정리, Kuratowski 보조정리
    - 정렬가능정리
    - 선택공리의 결과
...
- [군의 정의, 대칭군, 일반선형군](/2021/02/definition-group/)
- [부분군, 군의 생성](/2021/02/definition-subgroup/)
    - 일반선형군의 부분군
    - 치환의 부호와 교대군
- 원소의 위수
...
- 궤도, 안정화군, 추이적인 작용
- 정규화군, 중심화군
- [교환자군, 가해군](/2021/02/definition-solvable-group/)
    - [멱영군](/2021/02/definition-nilpotent-group/)
    - [$p$-군](/2021/02/definition-p-group/)
    - 단순군인 교대군
- Sylow 부분군, Sylow 정리
- 유한 abelian 군의 구조정리
    - 유한 abelian 군 상의 Fourier 변환
- 자유군
- 이면체군
- 정다면체군
...
- Sylow 정리에 관한 연습문제
    ...
    - 위수 12인 군의 가해성
    - 위수 15인 군의 분류
    - [위수 30인 군의 분류](/2021/02/group-classification-order-30/)
- 정규화군, 중심화군에 관한 연습문제

### Ring Theory

- [환의 정의](/2021/02/definition-ring/)
    - 다항식환, 차수, 다항식의 나눗셈
    - [체, 정역](/2021/02/integral-domain-and-field/)
- 환 상의 대수
- 아이디얼, 생성 아이디얼
    - 아이디얼의 연산
    - 잉여환
